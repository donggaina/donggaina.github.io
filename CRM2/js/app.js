...
},{"ngpmcQ":1}],5:[function(require,module,exports){
module.exports = function () {
     var $ = require('jquery');
    $(function() {

        $(document).delegate("#filter-btn", "click", function() {
            $("#filter-frame").toggleClass("hide");
        ...
        $(document).delegate(".comment", "click", function() {
            $(this).parent().children(".comment-toggle").toggleClass("hide");

        });


        // 点击评论区的取消按钮 清除评论区的内容
        $(document).delegate(".canclebtn", "click", function() {
...
var event = require('./app2');
var vue_module = require('./vue-module');

event();
vue_module();

},{"./app2":5,"./vue-module":7}],7:[function(require,module,exports){
module.exports = function () {
	 var Vue = require('vue');
    ...
    var HomePage2 = Vue.extend({
        template: '#homePage2'
    });
    var ClientPage = Vue.extend({
        template: '#clientPage'
    });
    var Followpage = Vue.extend({
        template: "#followpage"
    });
    var Remindpage = Vue.extend({
        template: "#remindpage"
    });
    var App = Vue.extend({});
